...
public class TenantLogin implements ActionListener {
    ...
    TenantLogin() {
        ...
        login = new JButton("Login as Tenant");
        ...
        signup = new JButton("Sign-up as Tenant");
        signup.setBounds(850, 420, 160, 50);
    ...
    private boolean validateLogin(String user, String pass) {
        try (Scanner scanner = new Scanner(new File("C:\\Users\\moyaz\\OneDrive\\Documents\\New folder\\ROOMMATE\\Data\\tenantdata.txt"))) {
