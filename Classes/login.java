...
public class login implements ActionListener {
    ...
    login() {
        ...
        ImageIcon image = new ImageIcon("C:\\Users\\moyaz\\OneDrive\\Desktop\\Siam Roomie version 2\\src\\Media\\loginBg.jpg");
        background = new JLabel(image);
        background.setBounds(0, 0, 1100, 700);

        // icon
        ImageIcon icon = new ImageIcon("C:\\Users\\moyaz\\OneDrive\\Desktop\\Siam Roomie version 2\\src\\Media\\Frmlogo.png");
    ...
    private boolean validateLogin(String user, String pass) {
        try (Scanner scanner = new Scanner(new File("C:\\Users\\moyaz\\OneDrive\\Desktop\\Siam Roomie version 2\\src\\tenantdata.txt"))) {
